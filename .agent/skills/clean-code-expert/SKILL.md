---
description: Expert in Code Quality, Refactoring, SOLID principles, and Naming. Mandatory reading for deep code reviews, structural improvements, and maintaining "craftsmanship" standards.
---
...
### 1. The Art of Naming
- **Meaningful Distinctions**: Avoid `ProductData` vs `ProductInfo`. If they are different, name them by their *difference*.
...
- **Explain "Why", Not "How"**: Good code explains *how* it works. Comments should explain the *business rationale* or non-obvious constraints.
